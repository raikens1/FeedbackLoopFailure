...
#' @return
#' @export
diagnosis_fn_X <- function(x, severity){
  c <- 1/(1 + exp(-(20*0 - 5 * x - 10)))

  return(1/(1 + exp(-(20*severity - 5 * x - 10))) - c)
}
...
#' @return
#' @export
diagnosis_fn_X_2 <- function(x, severity){
  c <- (1 - 0.75*x)/(1 + exp(-(20*0 - 10)))

  return((1 - 0.75*x)/(1 + exp(-(20*severity - 10))) - c)
}
...
#' @return
#' @export
diagnosis_fn_noX <- function(severity){
  c <- 1/(1 + exp(-(20*0 - 10)))

  return(1/(1 + exp(-(20*severity - 10))) - c)
}
