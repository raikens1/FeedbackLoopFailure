...
```{r}
df_tested <- test_cs_case2B_calibrated(df)
```
...
p <- ggarrange(ggarrange(case2a_incidence, case2a_rep,
          ncol = 2, nrow = 1, widths =c(2,3), legend = F),
...
#ggsave("figures/case2.pdf", p, width = 8, height = 5.5)
```
...
p <- ggarrange(a, b, ncol = 2, widths =c(2,3), legend = F)
p
#ggsave("figures/case3.pdf", p, width = 8, height = 2.75)
```
